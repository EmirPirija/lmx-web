 ...
 * ===================================================
 * 
 * OVO JE FRONTEND FALLBACK - Glavni podaci dolaze iz API-ja
 * 
 * Struktura u bazi:
 * - Country: Bosna i Hercegovina (id iz API-ja)
 * - State: Kantoni (FBiH) + Regije (RS) + Brčko Distrikt
 * - City: Gradovi i općine
 * 
 * Koristi se za:
 * - Offline fallback
 * - Brzo pretraživanje na frontendu
 * - Popularni gradovi
 */
