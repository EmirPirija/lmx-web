  ...
  const MobileSidebar = (
    <Sheet open={mobileMenuOpen} onOpenChange={handleMobileMenuOpenChange}>
      <SheetContent
        ...
        overlayClassName="z-[127] bg-slate-950/70"
        className="z-[128] h-auto w-screen max-w-none max-h-[min(82dvh,760px)] overflow-hidden rounded-t-[1.75rem] border-x-0 border-b-0 border-slate-200 bg-white p-0 shadow-2xl dark:border-slate-700 dark:bg-slate-900 [&>button]:hidden"
      >
