              ...
              return (
                <CustomLink key={tab.href} href={tab.href} className="relative flex-1">
                  ...
                  >
                    ...
                    <span className={cn("text-xs font-semibold", isActive ? "text-white" : "text-slate-700")}>
                      {tab.label}
                    </span>
                  </div>
                </CustomLink>
        ...
        <div className="bg-white border border-slate-200/80 rounded-xl p-3 shadow-sm">
          ...
          <div className="relative">
            <select
              ...
              className="w-full appearance-none px-4 py-3 pr-10 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400 transition-all cursor-pointer"
            >
              {tabs.map((tab) => (
