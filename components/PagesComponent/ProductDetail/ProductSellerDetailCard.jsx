...
const ProductSellerDetailCard = ({
  ...
  const hasBusinessHours = Boolean(isShop && businessHours && showBusinessHours);
    ...
    <>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden">
        ...
        <div className="p-4 space-y-4">
              ...
              <div className="flex items-center gap-2.5 mt-1 flex-wrap">
                ...
                {showRatings && ratingValue && (
                  <span className="inline-flex items-center gap-1 text-xs">
                    ...
                    <span className="font-semibold text-slate-900">{ratingValue}</span>
              ...
              {showBadges && badgeList.length > 0 && (
                <div className="flex items-center gap-1.5 mt-2">
                  ...
                  {badges.length > maxBadges && (
                    <span className="text-xs text-slate-400">+{badges.length - maxBadges}</span>
                  )}
                </div>
              )}
            </div>
          ...
          {/* Business hours */}
          {hasBusinessHours && todayHoursText && (
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-slate-900 hover:bg-slate-800 text-white text-sm font-medium rounded-xl transition-colors"
            >
              <MessageCircle className="w-4 h-4" />
              Pošalji poruku
            </button>
            ...
            {canMakeOffer && itemId && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-xl transition-colors"
              >
                Pošalji ponudu
              </button>
            )}
            ...
            {hasContactOptions && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-200 hover:bg-slate-50 text-slate-700 text-sm font-medium rounded-xl transition-colors"
              >
