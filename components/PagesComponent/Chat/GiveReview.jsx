...
import StarRatingInput from '@/components/PagesComponent/Reviews/StarRatingInput';
...
const GiveReview = ({ itemId, setSelectedChatDetails, setBuyer }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Kreiramo FormData za slanje sa slikama
      const formData = new FormData();
      formData.append('item_id', itemId);
      formData.append('review', review);
      formData.append('ratings', rating);
      
      // Dodajemo slike ako postoje
      ...
      const res = await addItemReviewApi.addItemReview({
        ...
        review,
        ratings: rating,
        images // Proslijedimo slike ako API podržava
      });
