...
const ComponentThree = ({
  ...
  const renderCustomFields = (field) => {
    ...
    switch (type) {
      ...
      case "fileinput":
        ...
        return (
          <>
            <label htmlFor={id} className="flex touch-manipulation cursor-pointer gap-2 items-center">
              <div className="border px-2.5 py-1 rounded">
  ...
  const requiredCompletionTransitionRef = useRef(requiredFieldsCompleted);
